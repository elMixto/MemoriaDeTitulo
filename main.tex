...
\usepackage{multicol}
\usepackage[Algoritmo]{algorithm}                    % Extensión para tablas
...
El clasificador utilizado es una red nuronal de cinco capas que como entrada usa features calculadas para un elemento de la instancia con las que genera una prediccion sobre si el elemento tendrá un valor de cero o uno en la solución final.
...
\begin{algorithm}
	...
	\begin{algorithmic}
		\State \textbf{let} $I$			  \Comment{El conjunto de elementos}
		\State \textbf{let} $Classifier$  \Comment{El clasificador}
		\Loop
